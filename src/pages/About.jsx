          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              <p className="text-lg leading-relaxed">
                I am an accomplished<span
                  className="text-white font-bold"> Senior Software Development Engineer</span> with over 5 years of
                experience in architecting high-performance enterprise systems.
                My career is defined by technical excellence at industry leaders like <span
                  className="text-blue-400 font-semibold">Amazon Prime Video</span> and <span
                  className="text-blue-400 font-semibold">Kroger</span>.
              </p>
              <p className="text-lg leading-relaxed">
                With a <span className="text-white font-bold">MS in Information Technology </span> from the University
                of Cincinnati, I bridge the gap between robust backend engineering and cutting-edge innovation.
                I thrive at the intersection of <span className="text-white">system design and observability</span>,
                turning complex challenges into production-grade realities.
              </p>
              <p className="text-lg leading-relaxed">
                Beyond core engineering, I am a certified <span className="text-white font-bold">Generative AI professional</span>.
                I've developed RAG-based chatbots and real-time gesture recognition applications using TensorFlow and
                PyTorch.
              </p>
            </motion.div>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              {roles.map((role, index) => (
                  ...
                  >
                    <div
                        className="bg-white/5 w-14 h-14 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-inner">
                      {role.icon}
                    </div>
