...
const Contact = () => {
  ...
  return (
    <section
      className="py-16 px-6 bg-transparent text-white text-center"
      id="contact"
    >
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mb-10">
        <a
          href="mailto:akhilreddyar989@gmail.com"
      ...
      >
        <div className="mb-4">
          <input
            ...
            required
            className="w-full p-3 rounded bg-black text-gray-300 placeholder-gray-500"
          />
        </div>
        <div className="mb-4">
          <input
